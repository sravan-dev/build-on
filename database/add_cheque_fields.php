...
try {
    ...
    $pdo->exec("ALTER TABLE payments ADD COLUMN cheque_number TEXT");
    echo "✓ Cheque number column added successfully to payments table\n";
...
try {
    ...
    $pdo->exec("ALTER TABLE payments ADD COLUMN bank_name TEXT");
    echo "✓ Bank name column added successfully to payments table\n";
} catch (PDOException $e) {
    if (strpos($e->getMessage(), 'duplicate column name') !== false) {
